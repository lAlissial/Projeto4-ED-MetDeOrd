c = ('\033[m',         # 0 - bg sem cores
     ...
     '\033[1;44m',     # 4 - bg azul
     '\033[1;45m',     # 5 - bg roxo
     '\033[1;97;46m',  # 6 - bg ciano
     '\033[1;47m',     # 7 - bg cinza
     '\033[7m' ,       # 8 - bg branco
     '\033[1;97;103m', # 9 - bg amarelo claro
     '\033[1;97;104m', # 10 - bg azul claro
     '\033[1;97;102m', # 11 - bg verde claro
     '\033[1;97;40m',  # 12 - bg preto
...
def cabecalho(txt, cor):
  print(linha())
  print(f'{c[cor]}{txt.center(50)}{c[0]}')
  print(linha())
